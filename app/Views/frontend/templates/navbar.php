            ...
            <div class="row">
                <div class="col-12 mainNavCol">
                    ...
                    <!-- <div class="logo mainNavCol">
                            <a href="index-2.html">
                                <img src="<?= base_url('assets_frontend/img/logo.png') ?>" class="img-fluid" alt="Logo">
                            </a>
                        </div> -->
                    <!-- logo -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-5">
                                    <a href="#" class="delivery-add p-relative"> <span class="icon"><i class="fas fa-map-marker-alt"></i></span>
                                        <span class="address">Welcome to Ahadiat | Hotel & Bungalow</span>
                                    </a>
                                </div>
                                <!-- location picker -->
                                <!-- search -->
                    ...
                    <div class="right-side fw-700 mainNavCol">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-5">
                                                <div class="ex-collection-box h-100">
                                                    <a href="#">
                                                        <img src="<?= base_url('assets_frontend/img/nav-1.jpg') ?>" class="img-fluid full-width h-100" alt="image">
                                                    </a>
                        ...
                        <!-- <div class="user-details p-relative">
                             <a href="#" class="text-light-white fw-500">
                                 <img src="<?= base_url('assets_frontend/img/user-1.png') ?>" class="rounded-circle" alt="userimg"> <span>Hi, Kate</span>
                             </a>
                        ...
                        <div class="cart-btn notification-btn">
                            ...
                            <div class="notification-dropdown">
                                <div class="product-detail">
                                    <a href="#">
                                        <div class="img-box">
                                            <img src="<?= base_url('assets_frontend/img/shop-1.png') ?>" class="rounded" alt="image">
                                        </div>
                                    ...
                                    <div class="card-body no-padding">
                                        ...
                                        <div class="item-total">
                                            <div class="total-price border-0"> <span class="text-dark-white fw-700">Items subtotal:</span>
                                                <span class="text-dark-white fw-700"><?= "Rp." . number_format($total), "." ?></span>
                                            </div>
                                            <div class="empty-bag padding-15"> <button id="pay-button" class="btn-first green-btn text-custom-white full-width fw-500">Pay!</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer padding-15"> <a href="checkout.html" class="btn-first green-btn text-custom-white full-width fw-500">Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
