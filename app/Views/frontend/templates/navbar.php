             ...
             <div class="row">
                 <div class="col-12 mainNavCol">
                     ...
                     <!-- <div class="logo mainNavCol">
                            <a href="index-2.html">
                                <img src="assets_frontend/img/logo.png" class="img-fluid" alt="Logo">
                            </a>
                        </div> -->
                     <!-- logo -->
                     ...
                     <div class="right-side fw-700 mainNavCol">
                                         ...
                                         <div class="row">
                                             <div class="col-lg-4 col-md-5">
                                                 <div class="ex-collection-box h-100">
                                                     <a href="#">
                                                         <img src="assets_frontend/img/nav-1.jpg" class="img-fluid full-width h-100" alt="image">
                                                     </a>
                         ...
                         <!-- <div class="user-details p-relative">
                             <a href="#" class="text-light-white fw-500">
                                 <img src="assets_frontend/img/user-1.png" class="rounded-circle" alt="userimg"> <span>Hi, Kate</span>
                             </a>
                         ...
                         <div class="cart-btn notification-btn">
                             ...
                             <div class="notification-dropdown">
                                 <div class="product-detail">
                                     <a href="#">
                                         <div class="img-box">
                                             <img src="assets_frontend/img/shop-1.png" class="rounded" alt="image">
                                         </div>
