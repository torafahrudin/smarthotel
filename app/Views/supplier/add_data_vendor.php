        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('vendor/create') ?>" method="POST" class="no-validated">
                            <?= csrf_field(); ?>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="id_vendor" class="col-form-label">ID Vendor</label>
                                    <input type="text" class="form-control" name="id_vendor" value="<?= $id_vendor; ?>" autocomplete="off" disabled>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nama_vendor" class="col-form-label">Nama vendor</label>
                                    <input type="text" class="form-control" name="nama_vendor" placeholder="Nama Vendor" autocomplete="off" value="<?= old('nama_vendor'); ?>">
