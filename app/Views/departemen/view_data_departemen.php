                                        ...
                                        <?php foreach ($departemen as $dpt) : ?>
                                            <tr>
                                                ...
                                                <td class="d-print-none text-center">
                                                    <a type="button" href="<?= base_url('departemen/edit/' . $dpt['id_departemen']) ?>"><i class="mdi mdi-pencil fa-lg text-warning"></i></a>
                                                    <a type="button" data-toggle="modal" data-target="#delete<?= $dpt['id_departemen']; ?>">
                    ...
                    <div class="modal-body">
                        <div class="mb-2 mt-1">
                            <div class="float-right d-none d-sm-block">
                                <input type="hidden" name="id_departemen" value="<?= $dpt['id_departemen'] ?>">
