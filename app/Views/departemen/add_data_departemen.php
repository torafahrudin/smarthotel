                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('departemen') ?>">Data Departemen</a></li>
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('departemen/add') ?>" method="POST" class="no-validated">
                            <?= csrf_field(); ?>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="id_departemen" class="col-form-label">ID departemen</label>
                                    <input type="text" class="form-control" name="id_departemen" value="<?= $id_departemen; ?>" autocomplete="off" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="nama_departemen" class="col-form-label">Nama departemen</label>
                                <input type="text" class="form-control" name="nama_departemen" placeholder="Nama departemen" autocomplete="off">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
