            ...
            <form action="<?= base_url('bahan/edit')?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Bahan" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="custom-select" name="jenis" id="jenis_bahan">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="stok" id="stok" class="form-control" placeholder="Stok Bahan" readonly>
                        </div>
                    </div>
                </div>
