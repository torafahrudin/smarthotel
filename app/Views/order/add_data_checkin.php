        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('order/addCheckin') ?>" method="POST" class="no-validated">
                            <?= csrf_field(); ?>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="id_order" class="col-form-label">ID Order</label>
                                    <input type="text" class="form-control" name="id_order" value="<?= $id_order; ?>" autocomplete="off" disabled>
                                </div>
                            </div>
                            <div class="form-row">
