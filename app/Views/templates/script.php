...
<script type="text/javascript">
    <?php// if (session()->getFlashdata('success')) { ?>
        ...
        // toastr.success("<?php //= session()->getFlashdata('success'); ?>");
    <?php// } else if (session()->getFlashdata('error')) {  ?>
        // toastr.options.closeButton = true;
        // toastr.options.progressBar = true;
        // toastr.options.positionClass = 'toast-top-right';
        // toastr.error("<?php //= session()->getFlashdata('error'); ?>");
    <?php //} else if (session()->getFlashdata('warning')) {  ?>
        // toastr.options.closeButton = true;
        // toastr.options.progressBar = true;
        // toastr.options.positionClass = 'toast-top-right';
        // toastr.warning("<?php//= session()->getFlashdata('warning'); ?>");
    <?php //} else if (session()->getFlashdata('info')) {  ?>
        //toastr.options.closeButton = true;
        // toastr.options.progressBar = true;
        // toastr.options.positionClass = 'toast-top-right';
        // toastr.info("<?php]//= session()->getFlashdata('info'); ?>");
    <?php// } ?>
</script>
<script type='text/javascript'>
    $(document).ready(function() {
