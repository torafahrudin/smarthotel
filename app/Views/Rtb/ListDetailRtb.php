                                ...
                                <table id="receipt_bill" class="table table-striped nowrap">
                                    ...
                                    <tbody id="new">
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('Payment/ListPayment/' . $row->id_order) ?>" type="button" class="btn btn-primary btn-sm">Bayar</a>
                                                </td>
                                                <td>
                                    ...
                                    <tfoot>
                                        <tr class="text-center">
                                            ...
                                            <th colspan="1">
                                                <a href="<?php echo base_url('Payment/ListPayment/' . $row->id_customer) ?>" type="button" class="btn btn-primary btn-sm">Bayar Semua</a>
                                            </th>
                                        </tr>
                                    </tfoot>
                                </table>
