            ...
            <div class="row section-padding-bottom u-line">
                ...
                <div class="col-md-5">
                    <div class="deals-image">
                        <img src="<?php    echo base_url() ?>/assetcust/img/deals/banner-1.jpg" class="img-fluid full-width" alt="#">
                    </div>
                </div>
            </div>
        </div>
 ...
 <!--    <section class="featured-partners section-padding-top">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="featured-product">
                                    <div class="featured-img">
                                        <a href="restaurant.html">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/deals/360x178/shop-1.jpg" class="img-fluid full-width" alt="#">
                                        </a>
                                        <div class="overlay-2 padding-10"> <span class="deal-tag">Only on Munchbox</span>
                                        </div>
                                    </div>
                                    <div class="featured-product-details">
                                        <div class="pro-logo">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/logo-7.jpg" class="img-fluid" alt="#">
                                        </div>
                                        <div class="pro-title">
                                            <h6 class="mb-1"><a href="restaurant.html" class="text-light-black fw-600">Great Burger</a></h6>
                            ...
                            <div class="swiper-slide">
                                <div class="featured-product">
                                    <div class="featured-img">
                                        <a href="restaurant.html">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/deals/360x178/shop-2.jpg" class="img-fluid full-width" alt="#">
                                        </a>
                                        <div class="overlay-2 padding-10"> <span class="deal-tag">Only on Munchbox</span>
                                        </div>
                                    </div>
                                    <div class="featured-product-details">
                                        <div class="pro-logo">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/logo-6.jpg" class="img-fluid" alt="#">
                                        </div>
                                        <div class="pro-title">
                                            <h6 class="mb-1"><a href="restaurant.html" class="text-light-black fw-600">Flavor Town</a></h6>
                            ...
                            <div class="swiper-slide">
                                <div class="featured-product">
                                    <div class="featured-img">
                                        <a href="restaurant.html">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/deals/360x178/shop-3.jpg" class="img-fluid full-width" alt="#">
                                        </a>
                                        <div class="overlay-2 padding-10"> <span class="deal-tag">Only on Munchbox</span>
                                        </div>
                                    </div>
                                    <div class="featured-product-details">
                                        <div class="pro-logo">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/logo-5.jpg" class="img-fluid" alt="#">
                                        </div>
                                        <div class="pro-title">
                                            <h6 class="mb-1"><a href="restaurant.html" class="text-light-black fw-600">Big Bites</a></h6>
                            ...
                            <div class="swiper-slide">
                                <div class="featured-product">
                                    ...
                                    <div class="featured-product-details">
                                        ...
                                        <div class="pro-title">
                                            <h6 class="mb-1"><a href="restaurant.html" class="text-light-black fw-600">Smile N’ Delight</a></h6>
  ...
  <!--   <section class="trending section-padding">
                            ...
                            <div class="swiper-slide">
                                <div class="product-box">
                                    <div class="product-img">
                                        <a href="restaurant.html">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/restaurants/255x150/shop-1.jpg" class="img-fluid full-width" alt="product-img">
                                        </a>
                                    </div>
                          ...
                          <i class="fas fa-star text-yellow"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="product-box">
                                    <div class="product-img">
                                        <a href="restaurant.html">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/restaurants/255x150/shop-11.jpg" class="img-fluid full-width" alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product-caption">
                                        <div class="title-box">
                          ...
                          <i class="fas fa-star text-yellow"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="product-box">
                                    <div class="product-img">
                                        <a href="restaurant.html">
                                            <img src="<?php    echo base_url() ?>/assetcust/img/restaurants/255x150/shop-13.jpg" class="img-fluid full-width" alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product-caption">
                                        <div class="title-box">
        ...
        <div class="u-line instagram-slider swiper-container">
            <ul class="hm-list hm-instagram swiper-wrapper">
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-3.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-1.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-2.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-4.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-5.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-6.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-7.jpg" alt="instagram"></a>
                </li>
                <li class="swiper-slide">
                    <a href="#"><img src="<?php    echo base_url() ?>/assetcust/img/restaurants/250x200/insta-8.jpg" alt="instagram"></a>
                </li>
            </ul>
        </div>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-links">
                        ...
                        <div class="appimg">
                            <a href="#">
                                <img src="<?php    echo base_url() ?>/assetcust/img/playstore.jpg" class="img-fluid" alt="app logo">
                            </a>
                        </div>
                        <div class="appimg">
                            <a href="#">
                                <img src="<?php    echo base_url() ?>/assetcust/img/appstore.jpg" class="img-fluid" alt="app logo">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="payment-logo mb-md-20"> <span class="text-light-white fs-14 mr-3">We are accept</span>
                        <div class="payemt-icon">
                            <img src="<?php    echo base_url() ?>/assetcust/img/card-front.jpg" alt="#">
                            <img src="<?php    echo base_url() ?>/assetcust/img/visa.jpg" alt="#">
                            <img src="<?php    echo base_url() ?>/assetcust/img/amex-card-front.png" alt="#">
                            <img src="<?php    echo base_url() ?>/assetcust/img/mastercard.png" alt="#">
                        </div>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url() ?>/assetcust/js/jquery.min.js"></script>
    <!-- Popper -->
    <script src="<?php echo base_url() ?>/assetcust/js/popper.min.js"></script>
    <!-- Bootstrap -->
    <script src="<?php echo base_url() ?>/assetcust/js/bootstrap.min.js"></script>
    <!-- Range Slider -->
    <script src="<?php echo base_url() ?>/assetcust/js/ion.rangeSlider.min.js"></script>
    <!-- Swiper Slider -->
    <script src="<?php echo base_url() ?>/assetcust/js/swiper.min.js"></script>
    <!-- Nice Select -->
    <script src="<?php echo base_url() ?>/assetcust/js/jquery.nice-select.min.js"></script>
    <!-- magnific popup -->
    <script src="<?php echo base_url() ?>/assetcust/js/jquery.magnific-popup.min.js"></script>
    <!-- Maps -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDnd9JwZvXty-1gHZihMoFhJtCXmHfeRQg"></script>
    <!-- sticky sidebar -->
    <script src="<?php echo base_url() ?>/assetcust/js/sticksy.js"></script>
    <!-- Munch Box Js -->
    <script src="<?php echo base_url() ?>/assetcust/js/munchbox.js"></script>
    <!-- /Place all Scripts Here -->
</body>


<!-- munchbox/ex-deals.html  05 Dec 2019 10:23:47 GMT -->
</html>